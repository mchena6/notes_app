    ...
    <div>
      ...
      >
        ...
        <svg
          ...
          height="16"
          fill="currentColor"
          className={`bi bi-caret-down-fill ${isOpen ? "rotate-180" : "rotate-0"}`}
          viewBox="0 0 16 16"
        >
      ...
      >
        <ul className=" overflow-hidden">
          ...
          {category.notes.length === 0 && (
            <li className="text-sm text-zinc-400 p-3">No hay notas aun...</li>
          )}
        </ul>
      </div>
    </div>
    ...
    <aside className="w-72 py-8 px-6 border-r border-zinc-700">
      ...
      <div className="relative w-full my-4">
        <svg
          ...
          height="16"
          fill="currentColor"
          className="bi bi-search absolute left-3 top-3 text-zinc-400"
          viewBox="0 0 16 16"
        >
      ...
      <form className="mt-8 pt-8" onSubmit={handleAddCategory}>
        ...
        <div className="flex gap-2">
          ...
          />
          <button className="p-2 bg-zinc-600 rounded">+</button>
        </div>
      </form>
    </aside>
  );
