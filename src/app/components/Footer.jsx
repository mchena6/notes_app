export default function Footer() {
  return (
    <footer className="bg-ghost border-t border-mauve/30 text-text-main mt-auto">
      <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              <img src="https://flowbite.com/docs/images/logo.svg" className="h-7 me-3" alt="FlowBite Logo" />
              <span className="text-text-main self-center text-2xl font-bold whitespace-nowrap">Flowbite</span>
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-xs font-bold text-candy uppercase tracking-wider">Resources</h2>
              <ul className="text-text-muted font-medium">
                <li className="mb-4">
                  <a href="https://flowbite.com/" className="hover:text-mauve transition-colors">Flowbite</a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" className="hover:text-mauve transition-colors">Tailwind CSS</a>
                </li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-xs font-bold text-candy uppercase tracking-wider">Follow us</h2>
              <ul className="text-text-muted font-medium">
                <li className="mb-4">
                  <a href="https://github.com/themesberg/flowbite" className="hover:text-mauve transition-colors">Github</a>
                </li>
                <li>
                  <a href="https://discord.gg/4eeurUVvTy" className="hover:text-mauve transition-colors">Discord</a>
                </li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-xs font-bold text-candy uppercase tracking-wider">Legal</h2>
              <ul className="text-text-muted font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:text-mauve transition-colors">Privacy Policy</a>
                </li>
                <li>
                  <a href="#" className="hover:text-mauve transition-colors">Terms &amp; Conditions</a>
                </li>
              </ul>
            </div>
          </div>
        </div>
        <hr className="my-6 border-mauve/20 sm:mx-auto lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-text-muted sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:text-mauve transition-colors">Flowbite™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" className="text-text-muted hover:text-candy transition-colors">
            ...
            <a href="#" className="text-text-muted hover:text-candy transition-colors ms-5">
